...
class Highlighter:
    def __init__(self, text_widget):
        ...
        self.numbers_colour = "#AE81FF"
        self.strings_colour = "#E6DB74"
        self.commentlines_colour = "#75715E"
        self.commentblocs_colour = "#75715E"
    ...
    def configure_tags(self):
        ...
        self.text_widget.tag_configure("commentline", foreground=self.commentlines_colour)
        self.text_widget.tag_configure("commentbloc", foreground=self.commentblocs_colour)
    ...
    def highlight(self, event=None):
        ...
        self.highlight_regex(r"[\"][^\']*[\"]", "string")
        #self.highlight_regex(r"^.*#.*$",   "commentline")
